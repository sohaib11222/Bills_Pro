  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <ThemedText style={styles.headerTitle}>Fund Card</ThemedText>
      ...
      >
        ...
        <LinearGradient
          ...
          style={styles.amountToPayContainer}
        >
          ...
          <Pressable style={styles.summaryModalContent} onPress={(e) => e.stopPropagation()}>
            ...
            <View style={styles.pendingContainer}>
              ...
              <ThemedText style={styles.pendingDescription}>
                You are about to fund your virtual card with{' '}
                <ThemedText style={styles.pendingAmount}>${depositAmount || '0'}</ThemedText>
              </ThemedText>
            </View>
            ...
            <View style={styles.summaryDetails}>
              <View style={styles.summaryRow}>
                <ThemedText style={styles.summaryLabel}>Amount to fund</ThemedText>
                <ThemedText style={styles.summaryValue}>${depositAmount || '0'}</ThemedText>
              </View>
              <View style={styles.summaryRow}>
              ...
              <View style={styles.summaryRow}>
                ...
                <ThemedText style={styles.summaryValue}>Card funding</ThemedText>
              </View>
            </View>
        ...
        >
          <Pressable style={styles.successModalContent} onPress={(e) => e.stopPropagation()}>
            ...
            <ThemedText style={styles.successMessage}>
              You have successfully funded your virtual card with a sum of{' '}
              <ThemedText style={styles.successAmount}>${depositAmount || '0'}</ThemedText>
            </ThemedText>
