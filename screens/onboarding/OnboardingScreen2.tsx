  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <ThemedText style={styles.title} weight="bold">Get instant</ThemedText>
        <ThemedText style={styles.title} weight="bold">virtual cards</ThemedText>
      </View>

      {/* Subtitle */}
      <ThemedText style={styles.subtitle}>
        Get your dollar virtual card at a cheap rate, spend ,{'\n'}shop with your card anytime
      </ThemedText>
...
const styles = StyleSheet.create({
  ...
  illustrationContainer: {
    position: 'absolute',
    top: height * 0.128, // ~119px
    left: width * 0.7,
    transform: [{ translateX: -width * 0.616 }], // ~265px
    width: width * 1.23, // ~530px
    height: height * 0.427, // ~398px
  },
  illustration: {
    width: 400,
    height: '100%',
